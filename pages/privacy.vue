<template>
  <div class="wrap">
    <h1>Privacy Policy for Ekballo University's Ekballo Chat</h1>

    <p>
      At Ekballo Chat, accessible from {{ url }}, one of our main priorities
      is the privacy of our
      visitors. This Privacy Policy document contains types of information that is collected and recorded by Ekballo Chat
      and how we use it.
    </p>
    ...
    <p>
      ...
      the information that they shared and/or collect in Ekballo Chat. This policy is not applicable to any information
    ...
    <p>
      Ekballo Chat follows a standard procedure of using log files. These files log visitors when they visit websites. All
    ...
    <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Ekballo Chat.</p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
      their respective advertisements and links that appear on Ekballo Chat, which are sent directly to users' browser.
      They
    ...
    <p>Note that Ekballo Chat has no access to or control over these cookies that are used by third-party advertisers.</p>

    <h2>Third Party Privacy Policies</h2>

    <p>
      Ekballo Chat's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
    ...
    <p>
      Ekballo Chat does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
